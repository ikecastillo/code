...
import static com.dt.jira.plugin.genericbarchart.utils.DateOperations.getListOfMonths;
import static com.dt.jira.plugin.genericbarchart.utils.DateOperations.getMonthYear;
import static com.dt.jira.plugin.genericbarchart.utils.DrillDown.setDrillDown;
import static com.dt.jira.plugin.genericbarchart.utils.DrillDown.setMonthlyDrillDown;
import static com.dt.jira.plugin.genericbarchart.utils.NumberFormatter.getNumberFormat;
import static com.dt.jira.plugin.genericbarchart.utils.NumberFormatter.parseNumberFormat;
                        ...
                        for(Map.Entry<String, List<Issue>>  finaljsonVar: finalJson.entrySet()){
                            ...
                            if(monthName.equalsIgnoreCase(_key)){
                                ...
                                String monthlyUrl = setMonthlyDrillDown(solutionGrOptId, key,
                                        ...
                                        xCoordinatesList.get(xCoordinatesList.size() - 1),
                                        groupBy, xAxisOnBarChart, depthOfCascade);
