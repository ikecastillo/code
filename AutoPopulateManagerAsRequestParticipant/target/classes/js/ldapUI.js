AJS.toInit(function() {
 // var baseUrl = AJS.$("meta[name='application-base-url']").attr("content");
  ...
  function populateForm() {	 
    AJS.$.ajax({
      url: "/rest/fiservicedeskldapintegration/1.0/fildapintegration/ldapsrvc",
      type: "GET",
  ...
  function updateConfig() {
	  ...
	  AJS.$.ajax({
	      url: "/rest/fiservicedeskldapintegration/1.0/fildapintegration/ldapsave",
	      type: "PUT",
	      contentType: "application/json",
  ...
  AJS.$("#fildapSrvc").submit(function(e) {
    e.preventDefault();
     updateConfig();
  });
});
