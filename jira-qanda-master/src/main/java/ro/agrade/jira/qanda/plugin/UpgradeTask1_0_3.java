 ...
 * @since 1.0
 */
public class UpgradeTask1_0_3 implements PluginUpgradeTask {
    private static final Log LOG = LogFactory.getLog(UpgradeTask1_0_3.class);

    private final UserManager userManager;

    public UpgradeTask1_0_3(UserManager userManager) {
