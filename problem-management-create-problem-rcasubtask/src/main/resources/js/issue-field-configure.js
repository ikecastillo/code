var Mapper = {
    addMapping: function() {
        ...
        if(AJS.$("#selectedDefaultIssueFields").val()!=='' &&  AJS.$("#mappingfield").val()!==''){
            ...
            AJS.$.ajax({
                url :"/rest/dt/rcasubtaskfieldsmap/1.0/RCASubtaskFieldMap/addFieldMappingField.json?jiraField="+AJS.$("#selectedDefaultIssueFields").val()+"&mappingField="+AJS.$("#mappingfield").val()+"&fromIssueType="+AJS.$("#selectedProjectIssueTypes").val()+"&toIssueType="+AJS.$("#selectedIssueTypes").val(),
                type: "PUT",
	...
	removeMapping:function(jiraField, mappingField,fromIssueType,toIssueType) {
       AJS.$.ajax({
                url :"/rest/dt/rcasubtaskfieldsmap/1.0/RCASubtaskFieldMap/deleteFieldMappingField.json?jiraField="+jiraField+"&mappingField="+mappingField+"&fromIssueType="+fromIssueType+"&toIssueType="+toIssueType,
                type: "PUT",
                contentType: 'application/json',
                success: function (response) {
	...
	getAllFieldMappings:function() {
        ...
        AJS.$.ajax({
            url: "/rest/dt/rcasubtaskfieldsmap/1.0/RCASubtaskFieldMap/getAllFieldMappings",
            dataType: "json",
            type: "PUT",
            success: function (response) {
