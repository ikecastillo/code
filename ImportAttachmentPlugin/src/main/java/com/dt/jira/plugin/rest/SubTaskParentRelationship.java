 ...
 */
@Path("/subtaskrelatnship")
public class SubTaskParentRelationship {
       ...
       //Map fileAttachmentMap = getFileAttachmentInfo();
        ...
        {    
			  ...
			  String summary = issue.getSummary();
				...
				//}	
				msg = message + "Index Start : " + end  + " Sub Task Issue Key: " + key + " Parent Issue ID for linking: "+ ParentKey;
				
					  output.add(new AttachmentDemoModel(msg));
