...
public class DeleteProjectResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the value value for this DeleteProjectResponse.
     * 
     * @return value
     */
    ...
    /**
     * Sets the value value for this DeleteProjectResponse.
     * 
     * @param value
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.wso2.org/php/xsd", ">deleteProjectResponse"));
