...
public class Logout  implements java.io.Serializable {
    ...
    /**
     * Gets the token value for this Logout.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this Logout.
     * 
     * @param token
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.wso2.org/php/xsd", ">logout"));
