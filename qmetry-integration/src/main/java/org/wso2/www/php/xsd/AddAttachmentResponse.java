...
public class AddAttachmentResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the attachmentId value for this AddAttachmentResponse.
     * 
     * @return attachmentId
     */
    ...
    /**
     * Sets the attachmentId value for this AddAttachmentResponse.
     * 
     * @param attachmentId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.wso2.org/php/xsd", ">addAttachmentResponse"));
