...
public class ListFolders  implements java.io.Serializable {
    ...
    /**
     * Gets the token value for this ListFolders.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ListFolders.
     * 
     * @param token
     */
    ...
    /**
     * Gets the type value for this ListFolders.
     * 
     * @return type
     */
    ...
    /**
     * Sets the type value for this ListFolders.
     * 
     * @param type
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.wso2.org/php/xsd", ">listFolders"));
