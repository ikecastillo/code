...
public class CreateUserResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the userId value for this CreateUserResponse.
     * 
     * @return userId
     */
    ...
    /**
     * Sets the userId value for this CreateUserResponse.
     * 
     * @param userId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.wso2.org/php/xsd", ">createUserResponse"));
