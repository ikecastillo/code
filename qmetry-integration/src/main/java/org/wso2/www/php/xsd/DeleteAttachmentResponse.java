...
public class DeleteAttachmentResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the success value for this DeleteAttachmentResponse.
     * 
     * @return success
     */
    ...
    /**
     * Sets the success value for this DeleteAttachmentResponse.
     * 
     * @param success
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.wso2.org/php/xsd", ">deleteAttachmentResponse"));
