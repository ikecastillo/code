/**
 * ListReleasesWithTargetDateResponse.java
 *
...
public class ListReleasesWithTargetDateResponse  implements java.io.Serializable {
    private org.wso2.www.php.xsd.Entity[] releases;

    public ListReleasesWithTargetDateResponse() {
    }
    ...
    /**
     * Gets the releases value for this ListReleasesWithTargetDateResponse.
     * 
     * @return releases
     */
    ...
    /**
     * Sets the releases value for this ListReleasesWithTargetDateResponse.
     * 
     * @param releases
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ListReleasesWithTargetDateResponse)) return false;
        ListReleasesWithTargetDateResponse other = (ListReleasesWithTargetDateResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ListReleasesWithTargetDateResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.wso2.org/php/xsd", ">listReleasesWithTargetDateResponse"));
