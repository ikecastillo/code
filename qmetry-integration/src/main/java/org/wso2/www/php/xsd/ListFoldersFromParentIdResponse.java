/**
 * ListFoldersFromParentIdResponse.java
 *
...
public class ListFoldersFromParentIdResponse  implements java.io.Serializable {
    private org.wso2.www.php.xsd.FolderDetails[] folderDetails;

    public ListFoldersFromParentIdResponse() {
    }
    ...
    /**
     * Gets the folderDetails value for this ListFoldersFromParentIdResponse.
     * 
    ...
    /**
     * Sets the folderDetails value for this ListFoldersFromParentIdResponse.
     * 
     * @param folderDetails
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ListFoldersFromParentIdResponse)) return false;
        ListFoldersFromParentIdResponse other = (ListFoldersFromParentIdResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ListFoldersFromParentIdResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.wso2.org/php/xsd", ">listFoldersFromParentIdResponse"));
