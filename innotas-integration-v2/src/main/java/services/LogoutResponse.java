...
public class LogoutResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the _return value for this LogoutResponse.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this LogoutResponse.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://services", ">logoutResponse"));
