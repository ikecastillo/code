...
import com.dt.jira.pagerduty.intgt.plugin.rest.ConfigResource;
 ...
 * 
 */
public class PDJobImpl implements PDJob, LifecycleAware {

	/* A unique job key */
	static final String KEY = PDJobImpl.class.getName() + ":instance";
	/* A unique job name */
	private static final String JOB_NAME = PDJobImpl.class.getName()
			+ ":job";
	/* Logger */
	...
	public PDJobImpl(PluginScheduler pluginScheduler,
	...
	public void reschedule(String query, long interval) {
		...
		pluginScheduler.scheduleJob(JOB_NAME,// unique name of the job
				PDScheduleJob.class, // class of the job
				new HashMap<String, Object>() {
					{
						put(KEY, PDJobImpl.this);
					}
