...
DTGADGET.descriptorArgsSummary = function (baseUrl) {
	...
	return [
        ...
        {
        	key: "solutionGroups",          
			ajaxOptions: baseUrl+ "/rest/exportrest/1.0/getSolutiionGroups.json?projectkey=ITIM",
			dataType: "json"
            ...
            {
        	key: "types",          
			ajaxOptions: baseUrl+ "/rest/exportrest/1.0/getType.json?projectkey=ITIM",
			dataType: "json" 
            },
             {
        	key: "impacteds",          
			ajaxOptions: baseUrl+ "/rest/exportrest/1.0/getLocation.json?projectkey=ITIM",
			dataType: "json"  
			
            },
             {
        	key: "locations",          
			ajaxOptions:baseUrl+ "/rest/exportrest/1.0/getType/getLocationProductValues?type=Internal",
			dataType: "json"
            }
    ];
};
